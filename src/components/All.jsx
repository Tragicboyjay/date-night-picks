        ...
        <div id="all">
            ...
            <nav id="all-nav">
                ...
                { showNav || windowWidth > 420 ?  
                    <ul>
                        <li className={allState === 'completed'? 'active': undefined} onClick={() => {setAllState('completed'); setShowNav(false)}}>Completed</li>
                        <li className={allState === 'activities'? 'active': undefined} onClick={() => {setAllState('activities'); setShowNav(false)}}>Activities</li>
                        <li className={allState === 'restaurants'? 'active': undefined} onClick={() => {setAllState('restaurants'); setShowNav(false)}}>Restaurants</li>
                        <li className={allState === 'all'? 'active': undefined} onClick={() => {setAllState('all'); setShowNav(false)}}>All</li>
                    </ul>
                : undefined}
            </nav>
